...
const cardStyle = `mb-8 p-4 border border-gray-900 rounded-md shadow-sm shadow-purple-900 hover:shadow-md hover:bg-purple-500 hover:text-white hover:dark:bg-gray-950`
